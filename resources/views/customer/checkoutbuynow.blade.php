...
<form action="{{route('buynowdata')}}" method="post" enctype="multipart/form-data">
    @csrf
                                ...
                                <table class="table table-stripeds table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <input type="hidden" name="item_price"
                                                value="{{ $item_price}}">
                                        <input type="hidden" name="quentity"
                                                value="{{ $quentity}}">
                                        ...
                                        <tr style="font-size: 1.5rem;">
                                            <td>
                                                <img src="{{ asset('/storage/' . $item_image) }}" alt="myImage" height="50px" width="50px" class="mr-2">
                                                {{ $item_name}}
                                            </td>
                                            <td>{{ $item_price}}</td>
                                            <td>{{ $quentity }}</td>
